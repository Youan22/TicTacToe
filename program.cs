...
namespace TIC_TAC_TOE
{
    class Program
    {
        //I am using array and for this program
        ...
        static void Main(string[] args)
        {
            do
            {
                Console.Clear();// whenever the loop is restart then the screen will be clear
                Console.WriteLine("Player1:X and Player2:O");
                Console.WriteLine("\n");
                if (player % 2 == 0)//checking the chance of the player
                {
                    Console.WriteLine("Player 2 Chance");
                    Console.WriteLine("Please select a number on the board");
                }
                else
                {
